...
import cv2
import numpy as np
trainingDirectory = '/home/martinez/TUS/DISSERT/data/latest/ForTraining/allImg'
targetLabelFile = '/home/martinez/TUS/DISSERT/data/latest/ForTraining/targets.txt'
...
for file in glob.glob("/home/martinez/TUS/DISSERT/data/latest/addNewData/*.png"):
    ...
    with open(targetLabelFile, 'a') as fd: 
        fd.write(f'{ os.path.basename(newFileName)+"|"+os.path.basename(file).replace(".png","")}\n')
